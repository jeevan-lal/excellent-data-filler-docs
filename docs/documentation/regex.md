...
- <img src="/svg/form.svg" class="doc-icon" /> [String Manipulation](/documentation/field-types/string-manipulation)
- <img src="/svg/form.svg" class="doc-icon" /> [String Matching](/documentation/field-types/string-matching)
